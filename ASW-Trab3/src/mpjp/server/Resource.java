 ...
 * static methods {@link #getPackageName()} and {@link #setPackageName(String)}
 * <p>
 * Content types are to assigned resources based on their file extensions by
 * the {@link #getContentType(String)} method. Currently, only a couple
 * of types are recognized and default to {@code application/octet-stream} 
 * 
 ...
 * asterisk in the content of the {@code url-pattern} element.  
 * 
 * <pre>
 * &lt;servlet&gt;
...
public class Resource extends HttpServlet {
	...
	private static String packageName = "mpjp.resources";
	...
	/**
	 * Change name of the package/directory holding the resources
	 * It may be a binary (dot-separated) name
	 *  
	...
	/**
	 * Sets the resource directory based on the WAR installation directory
	 * and the defined package name {@link #setPackageName(String)} 
	 */
	@Override
	...
	/**
	 * Return a content type based on the extension. Only a couple of types
	 * are currently supported. Defaults to {@code  application/octet-stream}
	 * 
